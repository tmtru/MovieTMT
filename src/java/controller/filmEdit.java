...
public class filmEdit extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet filmEdit</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet filmEdit at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
...
//        releaseDate=convertDateFormat(releaseDate);
        ...
        movie m=new movie(id,title, releaseDate, content, country, posterLink, actor, director,eps, viewers, rating, genre);
        MovieDAO dao=new MovieDAO();
        dao.editMovie(m);
        response.sendRedirect("filmDetail.jsp?id="+id);
    }
