...
public class homeFilms extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        if (movies.size()>15) movies.subList(15, movies.size()).clear();
        if (moviesR.size()>15) moviesR.subList(15, moviesR.size()).clear();
        if (moviesN.size()>15) moviesN.subList(15, moviesN.size()).clear();
